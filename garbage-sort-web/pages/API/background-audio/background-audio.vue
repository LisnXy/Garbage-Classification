    ...
    onLoad: function () {
        ...
        if (!bgAudioMannager.coverImgUrl) {
            bgAudioMannager.coverImgUrl =
                'https://vkceyugu.cdn.bspapp.com/VKCEYUGU-dc-site/c517b410-5184-11eb-b997-9918a5dda011.jpeg';
        }
        ...
        bgAudioMannager.onEnded(() => {
            ...
            this.$backgroundAudioData.formatedPlayTime = this.formatedPlayTime =
                util.formatTime(0);
        });
        ...
        bgAudioMannager.onTimeUpdate((e) => {
            if (
                ...
                this.$backgroundAudioData.formatedPlayTime =
                    this.formatedPlayTime = util.formatTime(
                        Math.floor(bgAudioMannager.currentTime),
                    );
            }
