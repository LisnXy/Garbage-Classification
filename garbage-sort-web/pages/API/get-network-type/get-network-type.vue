        ...
        <view class="uni-padding-wrap uni-common-mt">
            <view style="background: #ffffff; padding: 40rpx">
                ...
                <block v-if="hasNetworkType === false">
                    ...
                    <view class="uni-hello-text uni-center uni-common-mt">
                        请点击下面按钮获取网络状态
                    </view>
                </block>
                ...
                <view
                    v-if="hasNetworkType === true && networkType === 'wifi'"
                    class="uni-textarea uni-common-mt"
                >
                    <textarea :value="connectedWifi"></textarea>
                </view>
            </view>
            <view class="uni-btn-v uni-common-mt">
                <button type="primary" @tap="getNetworkType">
                    获取设备网络状态
                </button>
