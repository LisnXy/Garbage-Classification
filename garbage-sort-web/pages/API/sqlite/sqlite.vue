    ...
    <view>
        ...
        <view class="uni-padding-wrap uni-common-mt">
            <view class="uni-btn-v">
                <button type="primary" @click="openDB">
                    打开数据库test.db
                </button>
            </view>
            <view class="uni-btn-v">
                <button type="primary" @click="executeSQL">
                    创建表database及插入数据
                </button>
            </view>
            <view class="uni-btn-v">
                <button type="primary" @click="selectSQL">
                    查询表database的数据
                </button>
            </view>
            <view class="uni-btn-v">
                <button type="primary" @click="droptable">
                    删除表database
                </button>
            </view>
            <view class="uni-btn-v">
                <button type="primary" @click="closeDB">
                    关闭数据库test.db
                </button>
            </view>
            <view class="uni-btn-v">
                <button type="primary" @click="isOpenDB">
                    查询是否打开数据库
                </button>
            </view>
        </view>
    ...
    methods: {
        openDB: function () {
            plus.sqlite.openDatabase({
                ...
                fail: function (e) {
                    plus.nativeUI.alert(
                        '打开数据库test.db失败: ' + JSON.stringify(e),
                    );
                },
            });
        },
        ...
        selectSQL: function () {
            plus.sqlite.selectSql({
                ...
                success: function (e) {
                    plus.nativeUI.alert(
                        '查询SQL语句成功: ' + JSON.stringify(e),
                    );
                },
                fail: function (e) {
                    plus.nativeUI.alert(
                        '查询SQL语句失败: ' + JSON.stringify(e),
                    );
                },
            });
        },
        ...
        droptable: function () {
            plus.sqlite.executeSql({
                ...
                fail: function (e) {
                    plus.nativeUI.alert(
                        '删除表database失败: ' + JSON.stringify(e),
                    );
                },
            });
        },
