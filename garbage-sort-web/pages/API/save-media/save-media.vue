<template>
    <view>
        ...
        <view class="uni-padding-wrap">
            ...
            <button type="primary" class="uni-button" @click="saveImage">
                拍摄图片并保存到本地
            </button>
            ...
            <button type="primary" class="uni-button" @click="saveVideo">
                录制视频并保存到本地
            </button>
        </view>
    </view>
                        ...
                        success: (res) => {
                            ...
                            if (!authStatus) {
                                uni.showModal({
                                    title: '授权失败',
                                    content:
                                        'Hello uni-app需要从您的相机获取图片，请在设置界面打开相关权限',
                                    success: (res) => {
                                        if (res.confirm) {
                                            uni.openSetting();
                                        }
                        ...
                        success: (res) => {
                            ...
                            if (!authStatus) {
                                uni.showModal({
                                    title: '授权失败',
                                    content:
                                        'Hello uni-app需要从您的相机获取视频，请在设置界面打开相关权限',
                                    success: (res) => {
                                        if (res.confirm) {
                                            uni.openSetting();
                                        }
