        ...
        <view class="uni-padding-wrap">
            ...
            <view class="uni-btn-v uni- uni-common-mt">
                ...
                <button
                    ...
                    v-for="(value, key) in providerList"
                    @click="tologin(value)"
                    :key="key"
                >
                    登录
                ...
                <button
                    ...
                    @click="tologin(value)"
                    :loading="
                        value.id === 'univerify' ? univerifyBtnLoading : false
                    "
                    :key="key"
                >
                    {{ value.name }}
...
export default {
    ...
    onLoad() {
        ...
        if (this.hasLogin && this.isUniverifyLogin) {
            this.getPhoneNumber(uni.getStorageSync(univerifyInfoKey)).then(
                (phoneNumber) => {
