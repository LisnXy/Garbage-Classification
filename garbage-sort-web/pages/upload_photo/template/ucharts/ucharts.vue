<template>
    <view class="qiun-columns">
        ...
        <view class="qiun-padding">
            <view class="qiun-tip" @tap="changeGaugeData()">
                更新仪表盘数据
            </view>
        </view>
        <view class="qiun-bg-white qiun-title-bar qiun-common-mt">
        ...
        <view class="qiun-charts3">
            ...
            <canvas
                ...
                :style="{
                    ...
                    transform: 'scale(' + 1 / pixelRatio + ')',
                    'margin-left':
                        cWidth3 - (cWidth3 * (pixelRatio - 1)) / 2 + 'px',
                    'margin-top': (-cHeight3 * (pixelRatio - 1)) / 2 + 'px',
                }"
            ></canvas>
            <canvas
                ...
                :style="{
                    ...
                    transform: 'scale(' + 1 / pixelRatio + ')',
                    'margin-left':
                        cWidth3 * 2 - (cWidth3 * (pixelRatio - 1)) / 2 + 'px',
                    'margin-top': (-cHeight3 * (pixelRatio - 1)) / 2 + 'px',
                }"
            ></canvas>
            <!--#endif-->
    ...
    methods: {
                ...
                extra: {
                    gauge: {
                        ...
                        splitLine: {
                            ...
                            childNumber: 5,
                            childWidth:
                                _self.gaugeWidth * 0.4 * _self.pixelRatio, //仪表盘背景的宽度
                        },
                        pointer: {
        ...
        changeGaugeData() {
            ...
            for (let i = 0; i < _self.serverData.Gauge.categories.length; i++) {
                if (
                    series[0].data <= _self.serverData.Gauge.categories[i].value
                ) {
