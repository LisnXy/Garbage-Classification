<template>
    <view>
        ...
        <button
            class="button"
            @click="openBrowser('https://uniapp.dcloud.io/h5')"
        >
            使用浏览器打开指定URL
        </button>
        <button class="button" @click="openMarket()">
            使用应用商店打开指定App
        </button>
        <button
            class="button"
            @click="openMarket('com.tencent.android.qqdownloader')"
        >
            强制使用应用宝打开指定App
        </button>
        <button
            class="button"
            @click="openTaobao('taobao://s.taobao.com/search?q=uni-app')"
        >
            打开淘宝搜索页面
        </button>
    ...
    methods: {
        ...
        openMarket(marketPackageName) {
            ...
            if (plus.os.name == 'Android') {
                ...
                appurl =
                    'itms-apps://itunes.apple.com/cn/app/hello-uni-app/id1417078253';
            }
            ...
            plus.runtime.openURL(url, function (res) {
                uni.showModal({
                    ...
                    success: function (res) {
                        if (res.confirm) {
                            plus.runtime.openURL(
                                'https://s.taobao.com/search?q=uni-app',
                            );
                        }
                    },
                });
        ...
        openMap() {
            ...
            if (plus.os.name == 'Android') {
                ...
                var urlBaiduMap =
                    'baidumap://map/marker?location=39.968789,116.347247&title=DCloud&src=Hello%20uni-app';
                var urlAmap =
                ...
                if (hasAmap && hasBaiduMap) {
                    ...
                    url =
                        'geo:39.96310,116.340698?q=%e6%95%b0%e5%ad%97%e5%a4%a9%e5%a0%82';
                ...
                plus.nativeUI.actionSheet(
                    ...
                    function (e) {
                        ...
                        switch (e.index) {
                            ...
                            case 3:
                                url =
                                    'iosamap://viewMap?sourceApplication=Hello%20uni-app&poiname=DCloud&lat=39.9631018208&lon=116.3406135236&dev=0';
                                break;
                            default:
                                break;
                        }
        ...
        openQQ: function (e) {
            ...
            plus.runtime.openURL(
                'mqqwpa://im/chat?chat_type=' +
                    e.detail.value.qqNumType +
                    '&uin=' +
                    e.detail.value.qqNum,
                function (res) {
