    ...
    <view class="container">
        ...
        >
            <view class="uni-ma-5 uni-pb-5">
                ...
                <button class="uni-btn" type="primary" size="mini">
                    primary
                </button>
                <button class="uni-btn" type="success" size="mini">
                    success
                </button>
                <button class="uni-btn" type="warning" size="mini">
                    warning
                </button>
        ...
        >
            <view class="uni-ma-5 uni-pb-5">
                ...
                <button class="uni-btn" plain type="primary" size="mini">
                    primary
                </button>
                <button class="uni-btn" plain type="success" size="mini">
                    success
                </button>
                <button class="uni-btn" plain type="warning" size="mini">
                    warning
                </button>
                <button class="uni-btn" plain type="error" size="mini">
                    error
                </button>
                <button class="uni-btn" plain type="info" size="mini">
                    info
                </button>
            </view>
        </uni-section>
        ...
        >
            <view class="uni-ma-5 uni-pb-5">
                ...
                <button class="uni-btn" plain type="primary" disabled>
                    primary
                </button>
        ...
        >
            <view class="uni-ma-5 uni-pb-5">
                <button class="uni-btn" type="primary" disabled size="mini">
                    primary
                </button>
                <button
                    class="uni-btn"
                ...
                <button class="uni-btn uni-btn-radius" disabled size="mini">
                    圆角
                </button>
            </view>
        </uni-section>
