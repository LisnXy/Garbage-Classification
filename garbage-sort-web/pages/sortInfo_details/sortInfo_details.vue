<template>
    <view class="root">
        ...
        <!-- 选择栏 -->
        <view
            class="details-selectBox"
            :style="{ 'background-color': selectColor }"
        >
            <view class="items-container">
                <view
                    v-for="(item, index) in swiperTitles"
                    :key="index"
                    class="details-selectItems"
                >
                    <view
                        class="details-selectItemTitle"
                        @click="selectGarbageType(index)"
                    >
        ...
        <view class="details-body" :style="{ 'background-color': bodyColor }">
            ...
            >
                <view
                    ...
                    v-for="(item, index) in iconSource"
                    :key="index"
                >
                    <image
            ...
            <!-- 列表部分 -->
            <scroll-view
                class="details-list-block"
                :scroll-y="true"
                @scrolltolower="getGarbageList()"
            >
                <uni-list class="details_list">
                    <uni-list-item
                        v-for="(item, index) in garbageDetailsList"
                        :key="index"
                        :title="item"
                        :clickable="false"
                        :showArrow="false"
