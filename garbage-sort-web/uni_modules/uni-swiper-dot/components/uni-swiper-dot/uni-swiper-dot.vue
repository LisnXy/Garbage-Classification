    ...
    <view class="uni-swiper__warp">
        ...
        >
            <view
                ...
                :style="{
                    width:
                        (index === current ? dots.width * 2 : dots.width) +
                        'px',
                ...
                :style="{
                    ...
                    'background-color':
                        index !== current
                            ...
                            : dots.selectedBackgroundColor,
                    border:
                        index !== current ? dots.border : dots.selectedBorder,
                }"
                :key="index"
        ...
        >
            <view
                ...
                :style="{
                    width:
                        (index === current ? dots.width * 3 : dots.width) +
                        'px',
                    height: dots.height + 'px',
                    'background-color':
                        index !== current
        ...
        <view
            ...
            key="nav"
            :style="{
                'background-color': dotsStyles.backgroundColor,
                bottom: '0',
            }"
