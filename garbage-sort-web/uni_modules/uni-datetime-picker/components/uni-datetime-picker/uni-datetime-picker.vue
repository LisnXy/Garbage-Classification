        ...
        >
            <view v-if="!isRange" class="uni-date-single--x" :style="popover">
                ...
                <view v-if="hasTime" class="popup-x-footer">
                    <!-- <text class="">此刻</text> -->
                    <text class="confirm" @click="confirmSingleChange">
                        {{ okText }}
                    </text>
                </view>
            ...
            <view v-else class="uni-date-range--x" :style="popover">
                ...
                <view v-if="hasTime" class="popup-x-footer">
                    ...
                    <text class="confirm" @click="confirmRangeChange">
                        {{ okText }}
                    </text>
                </view>
            </view>
    ...
    computed: {
        ...
        reactEndTime() {
            const activeDate = this.isRange
                ...
                : this.tempSingleDate;
            const res =
                activeDate === this.caleRange.endDate
                    ? this.caleRange.endTime
                    : '';
            return res;
        },
        reactMobDefTime() {
            ...
            if (!Array.isArray(newVal) && !this.isRange) {
                ...
                if (this.hasTime) {
                    this.range.startDate =
                        defBefore.defDate + ' ' + defBefore.defTime;
                    this.range.endDate =
                        defAfter.defDate + ' ' + defAfter.defTime;
