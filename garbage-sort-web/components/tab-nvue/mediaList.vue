        ...
        >
            <view class="media-list view" v-if="options.title">
                <view
                    class="view"
                    :class="{
                        'media-image-right': options.article_type === 2,
                        'media-image-left': options.article_type === 1,
                    }"
                >
                    <text
                        class="media-title"
                        :class="{
                            'media-title2':
                                options.article_type === 1 ||
                                options.article_type === 2,
                        }"
                    >
                        {{ options.title }}
                    </text>
                    ...
                    >
                        ...
                        <image
                            class="image-list3"
                            v-if="options.image_list"
                            :src="source.url"
                            v-for="(source, i) in options.image_list"
                            :key="i"
                        />
                    </view>
                </view>
