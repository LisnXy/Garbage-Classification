    ...
    <view class="mpvue-picker">
        ...
        >
            ...
            >
                <!-- #ifdef VUE3 -->
                <template
                    v-for="(n, index) in pickerValueMulArray.length"
                    :key="index"
                >
                    <picker-view-column>
                        <view
    ...
    methods: {
        initPicker(valueArray) {
            ...
            if (this.mode === 'selector') {
                ...
                // 第一列
                for (
                    let i = 0, length = pickerValueArray.length;
                    i < length;
                    i++
                ) {
                ...
                if (this.pickerValueDefault.length === 2) {
                    ...
                    for (
                        let i = 0,
                            length = pickerValueArray[num].children.length;
                        i < length;
                        i++
                    ) {
                        pickerValueMulTwoTwo.push(
                            pickerValueArray[num].children[i],
                        );
                    }
                } else {
                    for (
                ...
                if (this.pickerValueDefault.length === 3) {
                    ...
                    for (
                        let i = 0,
                            length =
                                pickerValueArray[num].children[numSecond]
                                    .children.length;
                        i < length;
                        i++
                    ) {
                        pickerValueMulThreeThree.push(
                            pickerValueArray[num].children[numSecond].children[
                                i
                            ],
                        );
                    }
            ...
            if (this.deepLength === 2) {
                ...
                if (changeValue[0] !== this.pickerValue[0]) {
                    ...
                    for (
                        let i = 0,
                            length =
                                pickerValueArray[changeValue[0]].children
                                    .length;
                        i < length;
                        i++
                    ) {
                ...
                if (changeValue[0] !== this.pickerValue[0]) {
                    ...
                    for (
                        let i = 0,
                            length =
                                pickerValueArray[changeValue[0]].children[0]
                                    .children.length;
                        i < length;
                        i++
                    ) {
        ...
        _getPickerLabelAndValue(value, mode) {
            ...
            if (mode === 'selector') {
                ...
                for (let i = 0; i < value.length; i++) {
                    ...
                    pickerGetValue.push(
                        this.pickerValueMulArray[i][value[i]].value,
                    );
                }
                ...
                if (this.deepLength === 2) {
                    pickerGetValue.push(
                        this.pickerValueMulTwoOne[value[0]].value,
                    );
                    pickerGetValue.push(
                        this.pickerValueMulTwoTwo[value[1]].value,
                    );
                } else {
                    pickerGetValue.push(
                        this.pickerValueMulThreeOne[value[0]].value,
                    );
                    pickerGetValue.push(
                        this.pickerValueMulThreeTwo[value[1]].value,
                    );
                    pickerGetValue.push(
                        this.pickerValueMulThreeThree[value[2]].value,
                    );
                }
        ...
        _initPickerVale() {
            if (this.pickerValue.length === 0) {
                if (this.mode === 'selector') {
                    ...
                    this.pickerValue = new Int8Array(
                        this.pickerValueArray.length,
                    );
                } else if (
                    this.mode === 'multiLinkageSelector' &&
                    this.deepLength === 2
