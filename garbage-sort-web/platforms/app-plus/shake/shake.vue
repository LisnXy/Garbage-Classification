<template>
    <view class="root" :style="{ backgroundImage: 'url(' + img + ')' }">
        <view :class="[show ? 'up' : '', 'shake-up']">
            <image
                mode="aspectFit"
                src="https://vkceyugu.cdn.bspapp.com/VKCEYUGU-dc-site/b718cdb0-517d-11eb-a16f-5b3e54966275.png"
            ></image>
        </view>
        <view :class="[show ? 'down' : '', 'shake-down']">
            <image
                mode="aspectFit"
                src="https://vkceyugu.cdn.bspapp.com/VKCEYUGU-dc-site/b6600500-517d-11eb-8ff1-d5dcf8779628.png"
            ></image>
        </view>
    </view>
</template>
...
export default {
    ...
    onLoad: function () {
        ...
        this.music.src =
            'https://vkceyugu.cdn.bspapp.com/VKCEYUGU-dc-site/b5897b20-517d-11eb-a16f-5b3e54966275.wav';
        ...
        uni.onAccelerometerChange((res) => {
            if (
                ...
                setTimeout(() => {
                    ...
                    this.img =
                        'https://vkceyugu.cdn.bspapp.com/VKCEYUGU-dc-site/' +
                        this.pageIndex +
                        '.jpg';
                }, 2000);
                this.show = true;
