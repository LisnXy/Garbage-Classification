                    ...
                    for (l in n) {
                        if (
                            ...
                            (p = r.noTargetGet
                                ? (v = i(e, l)) && v.value
                                : e[l]),
                            !s(d ? l : h + (x ? '.' : '#') + l, r.forced) &&
                                p !== t)
                        ) {
                            if (typeof g == typeof p) continue;
                            f(g, p);
                        }
                        (r.sham || (p && p.sham)) && u(g, 'sham', !0),
                            c(e, l, g, r);
                    }
            };
        },
                ...
                { target: 'Array', proto: !0 },
                {
                    flat: function () {
                        var r = arguments.length ? arguments[0] : t,
                            ...
                            o = f(n, 0);
                        return (
                            (o.length = i(o, n, n, e, 0, r === t ? 1 : a(r))), o
                        );
                    },
                },
            );
            ...
            var e = n(45),
                ...
                u = function (t, r, n, c, a, f, s, l) {
                    for (var p, g = a, v = 0, h = !!s && i(s, l, 3); v < c; ) {
                        if (v in n) {
                            if (((p = h ? h(n[v], v, r) : n[v]), f > 0 && e(p)))
                                g = u(t, r, p, o(p.length), g, f - 1) - 1;
                            else {
        ...
        function (r, n, e) {
            ...
            r.exports = function (r) {
                var n,
                    ...
                    m = s(v);
                if (
                    (y && (x = o(x, d > 2 ? arguments[2] : t, 2)),
                    m == t || (h == Array && c(m)))
                )
                    for (e = new h((n = a(v.length))); n > b; b++)
                        f(e, b, y ? x(v[b], b) : v[b]);
                else
                    for (
                        g = (p = m.call(v)).next, e = new h();
                        !(l = g.call(p)).done;
                        b++
                    )
                        f(e, b, y ? u(p, x, [l.value, b], !0) : l.value);
                return (e.length = b), e;
            };
        },
        function (r, n, e) {
            ...
            t.exports = function (t, r, n, s, g, y, b) {
                ...
                if (
                    ...
                    if (
                        ...
                        for (O in S) (!h && !j && O in A) || f(A, O, S[O]);
                    ...
                    splice: function (t, r) {
                        ...
                        if (
                            (0 === b
                                ...
                                : 1 === b
                                ? ((n = 0), (e = x - y))
                                : ((n = b - 2), (e = p(l(i(r), 0), x - y))),
                            x + n - e > 9007199254740991)
                        )
                            throw TypeError('Maximum allowed length exceeded');
                        for (s = a(d, e), g = 0; g < e; g++)
                            (v = y + g) in d && f(s, g, d[v]);
                        if (((s.length = e), n < e)) {
                            for (g = y; g < x - e; g++)
                                (h = g + n),
                                    (v = g + e) in d
        ...
        function (t, r, n) {
            ...
            (t.exports = function (t, r, n, s, l) {
                ...
                if (l) p = t;
                    ...
                    if ('function' != typeof (g = c(t)))
                        throw TypeError('Target is not iterable');
                    if (o(g)) {
                        for (v = 0, h = i(t.length); h > v; v++)
                            if (
                                (d = s ? b(e((y = t[v]))[0], y[1]) : b(t[v])) &&
                                d instanceof f
                            )
                                return d;
                        return new f(!1);
                ...
                for (x = p.next; !(y = x.call(p)).done; )
                    if (
                        'object' == typeof (d = a(p, b, y.value, s)) &&
                        d &&
                        d instanceof f
                    )
                        return d;
            ...
            r.exports = {
                getConstructor: function (r, n, e, s) {
                    ...
                    return (
                        u(l.prototype, {
                            clear: function () {
                                for (
                                    var r = v(this), n = r.index, e = r.first;
                                    e;

                                )
                                    (e.removed = !0),
                                        e.previous &&
                                            (e.previous = e.previous.next = t),
                                        delete n[e.index],
                                        (e = e.next);
                                (r.first = r.last = t),
                                    p ? (r.size = 0) : (this.size = 0);
                            },
                            delete: function (t) {
                                var r = v(this),
                                    n = y(this, t);
                ...
                setStrong: function (r, n, e) {
                    ...
                    s(
                        ...
                        function () {
                            for (
                                var r = u(this), n = r.kind, e = r.last;
                                e && e.removed;

                            )
                                e = e.previous;
                            return r.target &&
                                (r.last = e = e ? e.next : r.state.first)
                                ? 'keys' == n
                                    ? { value: e.key, done: !1 }
                                    : 'values' == n
            ...
            t.exports =
                ...
                o(function () {
                    ...
                    return (
                        ...
                        7 != s({}, t)[n] ||
                            'abcdefghijklmnopqrst' != i(s({}, r)).join('')
                    );
                })
                    ? function (t, r) {
                          for (
            ...
            e(
                { target: 'String', stat: !0, forced: !!u && 1 != u.length },
                {
                    fromCodePoint: function (t) {
                        for (
                            var r, n = [], e = arguments.length, u = 0;
                            e > u;
                ...
                return [
                    ...
                    function (t) {
                        ...
                        for (var l, p = [], g = 0; null !== (l = f(o, c)); ) {
                            ...
                            (p[g] = v),
                                '' === v &&
                                    (o.lastIndex = a(c, u(o.lastIndex), s)),
                                g++;
                        }
                        return 0 === g ? null : p;
                    },
                ...
                a = function (r) {
                    return function (n, e, a) {
                        ...
                        return v <= p || '' == g
                            ? l
                            : ((f = v - p),
                              (s = i.call(g, c(f / g.length))).length > f &&
                                  (s = s.slice(0, f)),
                              r ? l + s : s + l);
                    };
                };
                ...
                return [
                    ...
                    function (r, u) {
                        ...
                        for (var b = []; ; ) {
                            ...
                            if ((b.push(m), !x)) break;
                            '' === String(m[0]) &&
                                (v.lastIndex = s(h, c(v.lastIndex), y));
                        }
                        for (var S, O = '', E = 0, w = 0; w < b.length; w++) {
                            m = b[w];
                            for (
                                var j = String(m[0]),
                                    A = p(g(a(m.index), h.length), 0),
                                    I = [],
                                    _ = 1;
                                _ < m.length;
                                _++
                            )
                                I.push((S = m[_]) === t ? S : String(S));
                            var N = m.groups;
                            if (d) {
