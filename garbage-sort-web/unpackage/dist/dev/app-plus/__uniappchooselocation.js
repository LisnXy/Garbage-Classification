!(function (e) {
    ...
    function (e, t, A) {
        ...
        function a(e, t, A, a, i, n, o, s, r, c) {
            ...
            if (r) {
                ...
                for (var h in r)
                    d.call(r, h) &&
                        !d.call(u.components, h) &&
                        (u.components[h] = r[h]);
            }
            if (
                (c &&
                    ((c.beforeCreate || (c.beforeCreate = [])).unshift(
                        function () {
                            this[c.__module] = this;
                        },
                    ),
                    (u.mixins || (u.mixins = [])).push(c)),
                t &&
                    ((u.render = t),
                    (u.staticRenderFns = A),
                    (u._compiled = !0)),
                ...
                'function' == typeof getUni
                    ...
                    : function () {
                          ...
                          var l = i.webview.currentWebview().id,
                              u = new BroadcastChannel('UNI-APP-SUBNVUE');
                          function d(e) {
                              ...
                              return (
                                  t &&
                                      ...
                                      (function (e) {
                                          e.$processed = !0;
                                          var t =
                                                  i.webview.currentWebview()
                                                      .id === e.id,
                                              A =
                                                  'uniNView' ===
                                                      e.__uniapp_origin_type &&
                          ...
                          var v = function (e, t) {
                                  var A = p[e];
                                  A
                                      ? (A(t), A.keepAlive || delete p[e])
                                      : console.error(
                                            'callback[' + e + '] is undefined',
                                        );
                              },
                              m = function (t) {
                                  var A,
                                  ...
                                  (p[i] =
                                      ...
                                      (e((A = o)) || (A && e(A.callback))) &&
                                          (a.keepAlive = !0),
                                      a)),
                                      h.postMessage(
                                          { id: i, type: n, params: o },
                                          '__uniapp__service',
                                      );
                              };
                          function w(e) {
                          ...
                          var j =
                              ...
                              P = function (e) {
                                  ...
                                  return 'object' ===
                                      (void 0 === e ? 'undefined' : j(e))
                                      ? 'POST' === t.toUpperCase() &&
                                        'application/json' === A.toLowerCase()
                                          ? JSON.stringify(e)
                                          : Object.keys(e)
                                                .map(function (t) {
                                                    return (
                              ...
                              Q = (function () {
                                  if ('function' == typeof getUniEmitter)
                          ...
                          var F = Object.freeze({
                                  ...
                                  getCurrentSubNVue: function () {
                                      return d(i.webview.currentWebview().id);
                                  },
                                  $on: function () {
                                      return U(
                                          Q(),
                    ...
                    initMessage: function () {
                        ...
                        var r = this,
                            c = function (e) {
                                ...
                                t &&
                                    r.__onMessageCallback &&
                                    r.__onMessageCallback(t.data);
                            };
                    ...
                    postMessage: function () {
                        ...
                        if ('v8' === this.__runtime)
                            if (this.__useGlobalEvent)
                                e.webview.postMessageToUniNView(a, i);
                            else {
                ...
                methods: {
                    initLocale: function () {
                        if (!this.__initLocale) {
                            this.__initLocale = !0;
                            var t =
                                (e.webview.currentWebview().extras || {})
                                    .data || {};
                            if (
                                (t.messages &&
                                    (this.localization.messages = t.messages),
                                t.locale)
                            )
        ...
        (function (e) {
            this.options.style || (this.options.style = {}),
                ...
                Vue.prototype.__merge_style
                    ...
                    : Object.assign(this.options.style, A(36).default);
        }.call(o),
            (t.default = o.exports));
    },
    ,
            ...
            var u = {
                ...
                computed: {
                    ...
                    searchMethods: function () {
                        return [
                            {
                                title: this.localize('nearby'),
                                method: 'poiSearchNearBy',
                            },
                            {
                ...
                methods: {
                        ...
                        'drag' === (A.causedBy || e.causedBy) &&
                            ...
                            this.mapContext.getCenterLocation(function (e) {
                                t.searchNearFlag
                                    ...
                                    : (t.searchNearFlag = !t.searchNearFlag);
                            });
                    },
                    onItemClick: function (e, t) {
                        (this.searchNearFlag = !1),
                            t.stopPropagation && t.stopPropagation(),
                            this.nearSelectedIndex !== e &&
                                (this.nearSelectedIndex = e),
                            this.moveToLocation(
                                this.nearList[e] && this.nearList[e].location,
                            );
                    },
                            ...
                            c.poiSearchNearBy(
                                ...
                                function (e) {
                                    (t.nearLoading = !1),
                                        ...
                                        (t.nearLoadingEnd =
                                            e.pageIndex === e.pageNumber),
                                        e.poiList && e.poiList.length
                                            ? (t.fixPois(e.poiList),
                                              (t.nearList = t.nearList.concat(
                                                  e.poiList,
                                              )),
                                              t.fixNearList())
                                            : (t.noNearData =
                    ...
                    onsearchinput: function (e) {
                        ...
                        this.clearSearchTimer(),
                            (this._searchInputTimer = setTimeout(function () {
                                clearTimeout(t._searchInputTimer),
                                    (t._searchPageIndex = 1),
                                    (t.searchEnd = !1),
                                    (t._searchKeyword = A),
                                    (t.searchList = []),
                                    t.search();
                    ...
                    onSearchItemClick: function (e, t) {
                        t.stopPropagation(),
                            this.searchSelectedIndex !== e &&
                                (this.searchSelectedIndex = e),
                            this.moveToLocation(
                                this.searchList[e] &&
                                    this.searchList[e].location,
                            );
                    },
                    getAddressStart: function (e) {
                        ...
                        return (
                            e.province +
                            (e.province === e.city ? '' : e.city) +
                            (/^\d+$/.test(e.district)
                                ? ''
                                : t.startsWith(e.district)
                                ? ''
                                : e.district)
                        );
                    },
                    fixPois: function (e) {
                        for (var t = 0; t < e.length; t++) {
                            ...
                            (A.name = A.name.replace(/\\/g, '')),
                                (A.addressOrigin = A.address.replace(
                                    /\\/g,
                                    '',
                                )),
                                (A.address =
                                    this.getAddressStart(A) + A.addressOrigin);
                        }
                    },
                    ...
                    [
                        A('view', { staticClass: ['page', 'flex-c'] }, [
                            ...
                            A(
                                'view',
                                {
                                    staticClass: ['flex-c', 'result-area'],
                                    class: { 'searching-area': e.showSearch },
                                },
                                [
    ...
    function (e, t, A) {
        ...
        Object.defineProperty(t, '__esModule', { value: !0 }),
            ...
            (t.default = function () {
                ...
                if (i())
                    return (
                        t.push(t.pop().replace('at ', 'uni-app:///')),
    ...
    function (e, t, A) {
        ...
        (a.default.mpType = 'page'),
            (a.default.route = 'template/__uniappchooselocation'),
            (a.default.el = '#root'),
            new Vue(a.default);
    },
]);
