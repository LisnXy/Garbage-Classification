                    ...
                    initMessage: function () {
                        ...
                        var u = this,
                            c = function (e) {
                                ...
                                t &&
                                    u.__onMessageCallback &&
                                    u.__onMessageCallback(t.data);
                            };
                    ...
                    postMessage: function () {
                        ...
                        if ('v8' === this.__runtime)
                            if (this.__useGlobalEvent)
                                e.webview.postMessageToUniNView(a, r);
                            else {
            ...
            methods: {
                ...
                columnchange: function (e) {
                    ...
                    Array.isArray(this.value) && this.$set(this.value, t, n),
                        this.postMessage(
                            { event: 'columnchange', column: t, value: n },
                            !0,
                        );
                },
            },
                ...
                h = {
                    ...
                    data: function () {
                        return {
                            ...
                            android:
                                'android' ===
                                weex.config.env.platform.toLowerCase(),
                        };
                    },
                    computed: {
                        rangeArray: function () {
                        ...
                        startArray: function () {
                            return this._getDateValueArray(
                                this.start,
                                c.bind(this)(),
                            );
                        },
                        ...
                        textMaxLength: function () {
                            return Math.floor(
                                Math.min(
                                    ...
                                    (this.fontSize * weex.config.env.scale +
                                        1) /
                    ...
                    methods: {
                        ...
                        _setValueSync: function () {
                            ...
                            switch (this.mode) {
                                case d.MULTISELECTOR:
                                    Array.isArray(e) || (e = []),
                                        Array.isArray(this.valueSync) ||
                                            (this.valueSync = []);
                                    for (
                                        var t = (this.valueSync.length =
                                                Math.max(
                                                    e.length,
                                                    this.range.length,
                                                )),
                        ...
                        _pickerViewChange: function (e) {
                            this.valueArray = this._l10nColumn(
                                e.detail.value,
                                !0,
                            );
                        },
