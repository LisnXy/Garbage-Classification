!(function (e) {
    ...
    function (e, t, n) {
        ...
        function a(e, t, n, a, o, r, i, s, c, u) {
            ...
            if (
                (u &&
                    ((u.beforeCreate || (u.beforeCreate = [])).unshift(
                        function () {
                          ...
                          var y = function (e, t) {
                              ...
                              m = function (t) {
                                  ...
                                  (v[o] =
                                      ...
                                      (e((n = i)) || (n && e(n.callback))) &&
                                          (a.keepAlive = !0),
                                      a)),
                                      p.postMessage(
                                          { id: o, type: r, params: i },
                                          '__uniapp__service',
                                      );
                              };
                          function _(e) {
                    ...
                    postMessage: function () {
                        ...
                        if ('v8' === this.__runtime)
                            if (this.__useGlobalEvent)
                                e.webview.postMessageToUniNView(a, o);
                            else {
            ...
            var c = e.barcode,
                ...
                f = {
                    ...
                    methods: {
                                ...
                                function (n) {
                                    n.code !==
                                        ...
                                        weex.config.env.platform.toLowerCase()
                                            ? 12
                                            : -2) &&
                                        e.nativeUI.toast(t.localize('fail'));
                                },
                                {
                                    multiple: !1,
                                    system: !1,
                        ...
                        setFlash: function () {
                            (this.enabledFlash = !this.enabledFlash),
                                this.$refs.barcode.setFlash(this.enabledFlash);
                        },
                    },
                };
            t.default = f;
                        ...
                        n(
                            ...
                            [
                                ...
                                n(
                                    'view',
                                    {
                                        staticClass: ['set-flash'],
                                        on: { click: e.setFlash },
                                    },
                                    [
                                        n('u-image', {
                                            staticClass: ['image-flash'],
                                            attrs: {
                                                src: e.enabledFlash
                                                    ? e.flashImage1
                                                    : e.flashImage0,
    ...
    function (e, t, n) {
        ...
        (a.default.mpType = 'page'),
            (a.default.route = 'template/__uniappscan'),
            (a.default.el = '#root'),
            new Vue(a.default);
    },
]);
