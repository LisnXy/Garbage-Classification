    ...
    login: function login() {var _this = this;
      wx.login({
        success: function success(res) {
          ...
          then(function (res) {
            _this.$store.commit('user/setOpenId', res.data.data.openid);
            if (res.data.data.isSaved === '1') {
              _this.$store.commit('user/setIsSaved', true);
                      ...
                      success: function success(res) {
                        ...
                        if (res.userInfo) {
                          ...
                          _request.default.post('/user/saveUser', {
                            code: _this.$store.state.user.openId,
        ...
        fail: function fail(err) {
          _this.$store.commit('user/setOpenId', 'o0A7N5PUiwU0xnj48RGFdqG1u51I');
        },
