...
public class ImageController {
    ...
    public Result<?> upload(MultipartFile file) throws IOException {
        ...
        String filePath = rootPath + "/garbage_sort_backend/src/main/resources/imageFiles/" + flag + "_" + fileName;   //目标路径
    ...
    public void download(@PathVariable String flag, HttpServletResponse response) {
        ...
        String basePath = System.getProperty("user.dir") + "/garbage_sort_backend/src/main/resources/multiResultImages/";   //目标文件夹路径
